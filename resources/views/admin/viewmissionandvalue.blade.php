...
@section('dashboard')
	<section class="content-header">
	    <h1>
	        Our Mision and Value
	    </h1>
	    <ol class="breadcrumb">
	    	<li><i class="fa fa-dashboard"></i> Home</a></li>
	        <li>Our Mision and Value</a></li>
	    </ol>
	</section>
@stop
    ...
    <div class="box-header">
       <div class="row no-print">
        <div class="col-xs-12">
          ...
          <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">  Add Another</button>
        </div>
      </div>
            ...
            <tbody>
                ...
                <tr class="item{{$n->id}}">
                    ...
                    <td><img src="{{url($n->image)}}" width="200px" height="200px"> </td>
                     ...
                     <td><a href="#"  class="editmission" data-id="{{$n->id}}" data-title="{{$n->title}}" data-description="{{$n->description}}" data-image="{{$n->image}}"   > <span class="label label-danger">Edit</span></a></td>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <!-- form goes here -->
       <form   enctype="multipart/form-data" id="addmission" >
...
<div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form   enctype="multipart/form-data" id="editmissiinnibchuh" data-id="edit_id"  >
