...
<section class="content-header">
      <h1>
        Add Event and Webinars
       
      </h1>
      <ol class="breadcrumb">
        <li><i class="fa fa-dashboard"></i> Home</a></li>
        <li>Add Events and Webinars</a></li>
          ...
          <div class="form-group">
           ...
           <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="date" data-date-inline-picker="false" data-date-popover='{"inline": true}' class="form-control pull-right" id="datepicker"  name="event_from" /> 
              ...
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <!-- <input class="form-control pull-right" id="datepicker" type="text"> -->
                  <input type="date" data-date-inline-picker="false" data-date-popover='{"inline": true}' class="form-control pull-right" id="datepicker"  name="event_to" /> 
